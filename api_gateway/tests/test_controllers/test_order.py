...
class TestOrder(AioHTTPTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.order_microservice.add_json_response('/order', {'product_added': 5}, methods=('POST',))
        self.order_microservice.add_json_response('/order/5/history', {'products': [1, 7, 49]}, methods=('GET',))
